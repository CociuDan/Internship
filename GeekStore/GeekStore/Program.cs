...
namespace GeekStore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DesktopCPU cpu = new DesktopCPU(3.40, 3.80, 4, "Intel", "i7 2600", 330, 1, "LGA1155", 95, 8);
            ...
            Desktop pc = new Desktop(cooler, cpu, disk, gpu, motherboard, psu, ram);
            Console.WriteLine(pc.Price);
            Console.ReadKey();

            LaptopCPU noteCpu = new LaptopCPU(2.8, 3.8, 4, "Intel", "i7 7700HQ", 35, 8);
